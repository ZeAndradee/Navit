    ...
    <div class="card-duvidas-interno">
        <div class="column">
            <div class="header-txt">
                <span class="header1">YOUME PERGUNTAS E RESPOSTAS</span>
                <span class="header2">Como podemos ajudar?</span>
                <div class="container">
                    <form action="" class="search-bar">
                        <input type="text" placeholder="Descreva o seu problema" name="q" class="focus:ring-0" autocomplete="off">
